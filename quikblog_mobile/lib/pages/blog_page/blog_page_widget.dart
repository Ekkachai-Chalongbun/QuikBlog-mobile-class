  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          top: true,
          child: StreamBuilder<BlogsRecord>(
            stream: BlogsRecord.getDocument(widget.blogRef!),
            builder: (context, snapshot) {
              ...
              final parentColumnBlogsRecord = snapshot.data!;
              return Column(
                  ...
                  Expanded(
                    child: StreamBuilder<UsersRecord>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        final scrollingColumnUsersRecord = snapshot.data!;
                                  ...
                                  child: Padding(
                                    ...
                                    child: StreamBuilder<BlogsRecord>(
                                      stream: BlogsRecord.getDocument(
                                          parentColumnBlogsRecord.reference),
                                      builder: (context, snapshot) {
                                        // Customize what your widget looks like when it's loading.
                                        if (!snapshot.hasData) {
                                          return Center(
                                        ...
                                        final contentColumnBlogsRecord =
                                            snapshot.data!;
                                        return Column(
                                          mainAxisSize: MainAxisSize.max,
                                          crossAxisAlignment:
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                '${dateTimeFormat('d/M/y', contentColumnBlogsRecord.createdTime)}   ${dateTimeFormat('H:mm', contentColumnBlogsRecord.createdTime)}',
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                                                    .override(
                                            ...
                                            Padding(
                                              ...
                                              child: StreamBuilder<
                                                ...
                                                builder: (context, snapshot) {
                                                  ...
                                                  List<CommentsRecord>
                                                      propertyDetailsCommentsRecordList =
                                                      snapshot.data!;
                                                  return Container(
                                                    width: double.infinity,
                                                    constraints: const BoxConstraints(
                                                                              ...
                                                                              children: [
                                                                                Text(
                                                                                  ...
                                                                                  style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                        fontFamily: 'Readex Pro',
                                                                                        color: true == true ? Colors.black : const Color(0x00000000),
                                                                                      ),
                                                                                ),
                                                                                Padding(
                                                                                  padding: const EdgeInsetsDirectional.fromSTEB(0.0, 4.0, 0.0, 0.0),
                                                                                  child: Text(
                                                                                    '${dateTimeFormat('d/M/y', commentsItem.createdTime)}   ${dateTimeFormat('H:mm', commentsItem.createdTime)}',
                                                                                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                          fontFamily: 'Readex Pro',
                                                                        ...
                                                                        children: [
                                                                          InkWell(
                                                                                  ...
                                                                                  return GestureDetector(
                                                                                    ...
                                                                                    child: Padding(
                                                                                      ...
                                                                                      child: SizedBox(
                                                                                        ...
                                                                                        child: RepliesWidget(
                                                                                          commentRef: commentsItem.reference,
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                Text(
                                                                                  '${commentsItem.replies.length.toString()} replies',
                                                                                  style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                        fontFamily: 'Readex Pro',
